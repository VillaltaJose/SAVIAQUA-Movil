...
class GenericFiltersSheet extends StatefulWidget {
  final bool mostrarCampoJunta;

  const GenericFiltersSheet({super.key, this.mostrarCampoJunta = true});
...
class _GenericFiltersSheetState extends State<GenericFiltersSheet> {
  ...
  void initState() {
    super.initState();
    _loadProvincias();
    if (widget.mostrarCampoJunta) _fetchPozos();
  }
  ...
  void _aplicarFiltro() {
    ...
    if (widget.mostrarCampoJunta && selectedJuntaId != null) {
      filtros['codigoJunta'] = '$selectedJuntaId';
    }
    filtros['codigoProvincia'] =
        selectedProvinciaId != null ? '$selectedProvinciaId' : 'null';
    filtros['codigoCiudad'] =
        selectedCiudadId != null ? '$selectedCiudadId' : 'null';
    filtros['codigoParroquia'] =
        selectedParroquiaId != null ? '$selectedParroquiaId' : 'null';
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            if (widget.mostrarCampoJunta) ...[
              DropdownButtonFormField<int>(
                value: selectedJuntaId,
                decoration:
                    _buildDropdownDecoration('Junta', LucideIcons.mapPin),
                dropdownColor: Colors.white,
                style: const TextStyle(fontSize: 14, color: Colors.black87),
                menuMaxHeight: 300,
                items: _isLoadingJuntas
                    ? [
            ...
            DropdownButtonFormField<int>(
              ...
              decoration:
                  _buildDropdownDecoration('Provincia', LucideIcons.building2),
              dropdownColor: Colors.white,
              style: const TextStyle(fontSize: 14, color: Colors.black87),
              menuMaxHeight: 300,
              items: _isLoadingProvincias
                  ? [
                      const DropdownMenuItem(
                        value: null,
                        child: Row(
                  ...
                  : provincias
                      ...
                      .toList(),
              onChanged: _isLoadingProvincias
                  ? null
                  : (value) {
                      setState(() {
            ...
            DropdownButtonFormField<int>(
              ...
              decoration:
                  _buildDropdownDecoration('Parroquia', LucideIcons.mapPin),
              dropdownColor: Colors.white,
              style: const TextStyle(fontSize: 14, color: Colors.black87),
              menuMaxHeight: 300,
              items: _isLoadingParroquias
                  ? [
                      const DropdownMenuItem(
                        value: null,
                        child: Row(
                  ...
                  : parroquias
                      ...
                      .toList(),
              onChanged: _isLoadingParroquias
                  ? null
